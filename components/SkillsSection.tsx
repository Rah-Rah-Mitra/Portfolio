    ...
    >
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-8 text-center">
        {skills.map((skill) => (
          <div 
            key={skill.id} 
            className="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-emerald-500/20 transform hover:scale-105 transition-all duration-300 flex flex-col items-center justify-center"
          >
            {skill.icon && (
