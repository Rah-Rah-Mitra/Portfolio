...
export const projectArchive: ProjectHighlight[] = [
  ...
  },
  {
    ...
    description: 'Dijkstra code for solving Gaza SSSP and APSP problems in an IE2110 group project.',
    tags: ['Jupyter Notebook', 'Dijkstra', 'Graphs', 'ISE'],
...
const careerAndEducationNotes: FieldNote[] = [
  {
    ...
    sortDate: '2026-01-01',
    source: 'Education',
    summary: 'Penultimate undergraduate in Industrial Systems Engineering and Management with a Second Major in Computer Science and a Mathematics Minor.',
