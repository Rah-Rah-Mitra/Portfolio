...
export const BLOCKED_SITE_IDS = {
  ...
  // Blocked in the 2026-11 pass. Both keep their full site cards on
  // list_projects and /api/portfolio: this withholds the résumé entry and the
